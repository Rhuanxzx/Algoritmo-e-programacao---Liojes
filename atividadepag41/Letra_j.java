...
mensagens: "O valor está na faixa permitida", caso o usuário forneça o valor nesta faixa, ou a mensagem "O valor
...
void main (){
    ...
    if(numero >= 1 && numero <= 9)
        IO.println(numero + " O número está dentro da faixa permitida ");
    else 
        IO.println(numero + " O número não está dentro da faixa permitida ");
}