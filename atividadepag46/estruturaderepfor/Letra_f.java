...
em que B é o valor da base e E o valor do expoente. Observe que neste exercício não pode ser utilizado o operador de exponenciação do
portuguol (^). */

void main (){
    int resposta = 1;
    int base = Integer.parseInt(IO.readln("digite uma base: "));
    int expoente = Integer.parseInt(IO.readln("digite um expoente: "));
